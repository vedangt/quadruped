#ifndef RCG_SHVAN1_JSIM_H_
#define RCG_SHVAN1_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot shvan1.
 */
class JSIM : public iit::rbd::StateDependentMatrix<rcg::shvan1::JointState, 18, 18, JSIM>
{
    private:
        typedef iit::rbd::StateDependentMatrix<rcg::shvan1::JointState, 18, 18, JSIM> Base;
    public:
